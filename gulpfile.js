...
(function () {
    ...
    gulp.task("svg-sprite", function () {
        ...
        return gulp.src([filters.svg, "!" + paths.iconSprite], {
                base: paths.icons,
                cwd: paths.icons
            })
    ...
    gulp.task("copy", function () {
        return gulp.src([filters.svg, filters.html, filters.images, filters.json], {
                base: paths.cwd,
                cwd: paths.src
            })
    ...
    gulp.task("watcher", function (done) {
        gulp.watch([filters.svg, filters.html, filters.images, filters.json], {
            cwd: paths.src
        }, function (event) {
        ...
        gulp.watch([filters.css, filters.scss], {
            cwd: paths.src
        }, function (event) {
            gutil.log("Modified:", colors.yellow(event.path));
            runSequence("sass");
